<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primaryLight via-white to-primaryDark p-6 relative overflow-hidden">
    ...
    <!-- Main container -->
    <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl flex flex-col md:flex-row w-full max-w-5xl overflow-hidden relative animate-fade-in border border-white/20">
      <!-- Left side with form -->
      <div class="w-full md:w-1/2 p-10 relative">
        <div class="animate-fade-in delay-300">
          ...
          <form @submit.prevent="submitForm" class="space-y-5">
            ...
            <div class="relative">
              <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-700 transition-all duration-200"
          ...
          <div class="text-center mt-8 p-4 bg-gray-50 rounded-lg">
            <p class="text-sm text-gray-600">
              ...
              <router-link to="/login" class="text-primaryDark hover:text-primaryLight font-medium transition-colors duration-200 hover:underline">
                Login here
              </router-link>
            </p>
          </div>
